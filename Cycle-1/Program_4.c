...
int minimize_dfa() {
    // Initialize partitions: non-final and final states
    ...
    while (changed && iteration <= 10) {  // Add safety limit
        changed = 0;
        printf("Iteration %d:\n", iteration);
        ...
        for (int p = 0; p < num_partitions; p++) {
            ...
            // Check if states in this partition are distinguishable
            ...
            for (int i = 1; partitions[p][i]; i++) {
                ...
                // Check if transitions go to different partitions
                ...
                if (distinguishable) {
                    ...
                    // Move curr_state to new partition
                    partitions[num_partitions][0] = curr_state;
                    partitions[num_partitions][1] = '\0';
